...
main:	stp	x29,	x30,	[sp, -16]!
	...
	mov	mnd_r,	-252645136	//Sets multiplicand value
	mov	mer_r,	-256		//Sets multiplier value
...
test1:	cmp	i_r,	32		//Checks loop count
	...
	cmp	neg_r,	0		//Checks if multiplier is negative
	b.eq	skip			//Skips the next operation if it is not equal
